      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-14">
                ...
                <Card className="h-full border-primary/10 bg-card/50 backdrop-blur-sm">
                  <CardContent className="pt-6">
                    ...
                    <div className="space-y-4">
                      ...
                      <div>
                        <p className="font-medium">PUC (11th & 12th)</p>
                        <p className="text-sm text-muted-foreground">SLV PU College, Chitradurga</p>
                        <p className="text-sm text-muted-foreground">2020 - 2022</p>
                        <p className="text-sm text-muted-foreground">Percentage: 94.6%</p>
                      </div>

                      <div>
                        <p className="font-medium">10th Grade</p>
                        <p className="text-sm text-muted-foreground">SJMR(CBSE) School, Chitradurga</p>
                        <p className="text-sm text-muted-foreground">2020</p>
                        <p className="text-sm text-muted-foreground">Percentage: 84.2%</p>
                      </div>
          ...
          >
            ...
            >
              <h3 className="text-2xl font-bold">Aishwarya Anand</h3>
              <p className="text-muted-foreground">
            ...
            >
              <Button className="gap-2" asChild onClick={handledownload}>
                <a href={resumeUrl} download="AISHWARYA_A_RESUME.pdf">
